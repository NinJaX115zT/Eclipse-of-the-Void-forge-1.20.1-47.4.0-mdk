...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case ETHEREAL -> ModItems.ETHEREAL_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.ETHEREAL.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        ETHEREAL(ModBlocks.ETHEREAL_PLANKS.get(), "ethereal");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, ETHEREAL);
        }
    }
}
